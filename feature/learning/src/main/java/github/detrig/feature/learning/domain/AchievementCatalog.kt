    ...
    fun create(config: LearningConfig): AchievementCatalog {
        ...
        val definitions = buildList {
            add(achievement(
                ...
                "Ребёнок познакомился с распределением денег между обязательными расходами, желаниями, сбережениями и финансовой подушкой.",
            ))
            add(achievement(
                LearningMetricIds.BUDGET_REASONABLE_PLAN,
                LearningTopicIds.BUDGET_PLANNING,
                ...
                "Ребёнок умеет составлять недельный план, в котором хватает денег на обязательные расходы.",
            ))
            add(achievement(
                ...
                "Ребёнок познакомился со сравнением недельного плана с фактическими расходами.",
            ))
            add(achievement(
                LearningMetricIds.BUDGET_FOLLOW_PLAN,
                LearningTopicIds.BUDGET_PLANNING,
                ...
                "Ребёнок умеет следовать недельному плану на протяжении нескольких игровых периодов.",
            ))
            add(achievement(
                ...
                "Ребёнок познакомился с тем, как неожиданный расход, дополнительный доход или изменение цены влияет на бюджет.",
            ))
            add(achievement(
                LearningMetricIds.BUDGET_ADAPT_TO_CHANGE,
                LearningTopicIds.BUDGET_PLANNING,
                ...
                "Ребёнок умеет адаптировать оставшиеся расходы к изменившейся финансовой ситуации.",
            ))
            ...
            add(achievement(
                ...
                "Ребёнок познакомился с созданием финансовой цели.",
            ))
            add(achievement(
                LearningMetricIds.SAVINGS_CREATE_GOAL,
                LearningTopicIds.SAVINGS_BUILDING,
            ...
            add(achievement(
                ...
                "Ребёнок познакомился с откладыванием денег на финансовую цель.",
            ))
            add(achievement(
                LearningMetricIds.SAVINGS_REGULAR_CONTRIBUTION,
                LearningTopicIds.SAVINGS_BUILDING,
                ...
                "Ребёнок умеет пополнять финансовую цель на протяжении нескольких игровых периодов.",
            ))
            add(achievement(
                ...
                "Ребёнок познакомился с завершением накопления на выбранную цель.",
            ))
            add(achievement(
                LearningMetricIds.SAVINGS_REACH_GOAL,
                LearningTopicIds.SAVINGS_BUILDING,
                ...
                "Ребёнок умеет доводить план накопления до достижения цели.",
            ))
            ...
            add(achievement(
                ...
                "Ребёнок познакомился с проверкой того, подходит ли покупка текущему бюджету и обязательным потребностям.",
            ))
            add(achievement(
                LearningMetricIds.PURCHASE_REASONABLE,
                LearningTopicIds.PAYMENTS_AND_PURCHASES,
                ...
                "Ребёнок умеет оценивать покупку с учётом доступных денег и предстоящих обязательных расходов.",
            ))
            add(achievement(
                ...
                "Ребёнок познакомился с проверкой реальной пользы акции.",
            ))
            add(achievement(
                LearningMetricIds.PURCHASE_PROMOTION,
                LearningTopicIds.PAYMENTS_AND_PURCHASES,
                ...
                "Ребёнок умеет оценивать акции с учётом цены, необходимости покупки и доступных денег.",
            ))
            add(achievement(
                ...
                "Ребёнок познакомился с паузой перед импульсивной покупкой.",
            ))
            add(achievement(
                LearningMetricIds.PURCHASE_IMPULSE,
                LearningTopicIds.PAYMENTS_AND_PURCHASES,
                ...
                "Ребёнок умеет оценивать импульсивное желание, не ставя под угрозу обязательные расходы.",
            ))
            ...
            add(achievement(
                ...
                "Ребёнок познакомился с тем, почему просьба сообщить код подтверждения подозрительна.",
                learnedThreshold = 3,
            ))
            add(achievement(
                LearningMetricIds.SECURITY_CONFIRMATION_CODE,
                ...
                "Ребёнок умеет хранить коды подтверждения в тайне и обращаться за помощью к взрослому.",
                learnedThreshold = 3,
            ))
            add(achievement(
                ...
                "Ребёнок познакомился с тем, почему неизвестная ссылка может быть опасна.",
                learnedThreshold = 3,
            ))
            add(achievement(
                LearningMetricIds.SECURITY_UNKNOWN_LINK,
                ...
                "Ребёнок умеет распознавать неизвестные ссылки и самостоятельно выбирать безопасную реакцию.",
                learnedThreshold = 3,
            ))
        }
